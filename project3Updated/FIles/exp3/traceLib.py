...
def tcpPacketCountExp3(traceLines,nodeStart,nodeEnd,timeStart,timeFinal):
	pacCountDict={}
	...
	for x in range(0,len(traceLines)):
		...
		if line[0]=='+' and line[4]=='tcp' and line[8]==node1 and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal) and line[9]==node2:
			tcpPacEnq+=1
			tcpPac+=1
			
		elif line[0]=='+' and line[4]=='ack' and line[8]==node2 and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal) and line[9]==node1:

			ackPacDeq+=1
			ackPac+=1	
		elif line[0]=='-' and line[4]=='tcp' and line[8]==node1 and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal) and line[9]==node2:
			tcpPacDeq+=1
			tcpPac+=1
			...
			ackPacDeq+=1
			ackPac+=1
		elif line[0]=='r' and line[4]=='tcp' and line[8]==node1 and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal) and line[9]==node2:
			tcpPacRecv+=1
			tcpPac+=1
		elif line[0]=='r' and line[4]=='ack' and line[8]==node2 and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal) and line[9]==node1:

			ackPacRecv+=1
			ackPac+=1
		elif line[0]=='c' and line[4]=='tcp' and line[8]==node1 and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal) and line[9]==node2:
			tcpPacCong+=1
			tcpPac+=1
		
		elif line[0]=='c' and line[4]=='ack' and line[8]==node2 and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal) and line[9]==node1:
			ackPacCong+=1
			ackPac+=1
		elif line[0]=='d' and line[4]=='tcp' and line[8]==node1 and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal) and line[9]==node2:
			tcpPacDrop+=1
			tcpPac+=1
		
		elif line[0]=='d' and line[4]=='ack' and line[8]==node2 and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal) and line[9]==node1:
			ackPacDrop+=1
			ackPac+=1
		# pacType=line[4]
		# print(pacType)
	...
	pacCountDict['dropped']=tcpPacDrop+ackPacDrop
...
def calcAvgLatency(traceLines,node1,node2,nodeStart,nodeEnd):
	...
	for x in range(0,len(traceLines)):
		line=traceLines[x].split(" ")
		if line[0]=='+' and line[2]==str(node1) and line[3]==str(node2) and line[8]==startNode and line[9]==endNode and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal):
			
			
			start_time.update({line[11]: float(line[1])})
			
			
		elif line[0]=='r' and line[2]==str(node1) and line[3]==str(node2) and line[8]==startNode and line[9]==endNode and float(line[1])>float(timeStart) and float(line[1])<float(timeFinal):
...
def calcAvgLatencyExp3(traceLines,node1,node2,nodeStart,nodeEnd,timeStart,timeFinal):
